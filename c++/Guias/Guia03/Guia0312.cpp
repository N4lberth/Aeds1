...
// executar a opcao de comando
 ...
 // nao fazer nada
 break;
 case 1: // inverter a direcao do movimento
 ...
 break;
 case 3: // Fazer curva fechada a esquerda
  while ( !leftIsClear ( ) )
 {
    facingEast( );
    move( );
...
/**
  ...
  * 0 - turnOff
  * 1 - turnAround               2 - to South
  * 3 - turnAroundCornerLeft     4 - to West 
  * 5 - move                     6 - to East
