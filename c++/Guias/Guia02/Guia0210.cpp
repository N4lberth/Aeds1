...
#include "karel.hpp"
#include "io.hpp"  // para entrada e saida
...
Versao Teste
 ...
 0.4    01. ( ok ) teste pegar beeper no quadrado
 0.5    01. ( ok ) teste da mensgem na tela
 0.6    01. ( ok ) teste controle manual
 0.7    01. ( ok ) teste salvar acoes do usuario
 0.8    01. ( ok ) teste repetir acao
 0.9    01. ( ok ) teste action
 1.0    01. ( ok ) teste record actiom
*/