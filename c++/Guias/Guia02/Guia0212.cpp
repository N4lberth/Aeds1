...
void decorateWorld ( const char* fileName )
{
 // colocar paredes no mundo
   ...
   world->set ( 6, 1, HWALL );
   world->set ( 7, 1, HWALL );
   world->set ( 3, 4, HWALL ); // parede horizontal
   world->set ( 4, 4, HWALL );
   world->set ( 6, 4, HWALL );
   world->set ( 7, 4, HWALL );
   world->set ( 3, 5, HWALL ); // parede horizontal
   world->set ( 4, 5, HWALL );
   world->set ( 6, 5, HWALL );
   world->set ( 7, 5, HWALL );
   ...
   world->set ( 5, 3, HWALL );
   world->set ( 5, 6, HWALL );
   world->set ( 2, 2, VWALL ); // parede vertical
   world->set ( 2, 3, VWALL );
   world->set ( 2, 4, VWALL );
   world->set ( 2, 6, VWALL );
   world->set ( 2, 7, VWALL );
   world->set ( 2, 8, VWALL );
   world->set ( 7, 2, VWALL ); // parede vertical
   world->set ( 7, 3, VWALL );
   world->set ( 7, 4, VWALL );
   world->set ( 7, 6, VWALL );
   world->set ( 7, 7, VWALL );
   ...
   world->set ( 4, 5, VWALL );
   world->set ( 5, 5, VWALL );
   world->set ( 4, 2, VWALL ); // parede vertical
   world->set ( 4, 3, VWALL );
   world->set ( 4, 7, VWALL );
   world->set ( 4, 8, VWALL );
   world->set ( 5, 2, VWALL ); // parede vertical
   world->set ( 5, 3, VWALL );
   world->set ( 5, 7, VWALL );
   world->set ( 5, 8, VWALL );
